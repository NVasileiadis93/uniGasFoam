...
void Foam::uspParcel::readFields(Cloud<uspParcel>& c)
{
    if (!c.size())
    {
        return;
...
void Foam::uspParcel::writeFields(const Cloud<uspParcel>& c)
{
    ...
    label i = 0;
    forAllConstIter(uspCloud, c, iter)
    {
