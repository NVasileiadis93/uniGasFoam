...
void Foam::uspParcel::hitProcessorPatch
(
    uspCloud& cloud,
    trackingData& td
)
...
void Foam::uspParcel::hitWallPatch
(
    uspCloud& cloud,
    trackingData& td
)
...
void Foam::uspParcel::transformProperties
(
    const tensor& T
)
{
