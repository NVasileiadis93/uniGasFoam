...
namespace Foam
{
defineTypeNameAndDebug(uspReaction, 0);
defineRunTimeSelectionTable(uspReaction, dictionary);
}


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::uspReaction::dissociatePQ
(
...
void Foam::uspReaction::ionisePQ
(
    const scalar& heatOfReaction,
    const labelPair& productIDs,
    uspParcel& p,
...
Foam::scalar Foam::uspReaction::EVib
(
    const uspParcel& p
) const
{
...
Foam::scalar Foam::uspReaction::ERot
(
    const uspParcel& p
) const
{
...
Foam::scalar Foam::uspReaction::EEle
(
    const uspParcel& p
) const
{
...
Foam::scalar Foam::uspReaction::m
(
    const uspParcel& p
) const
{
...
Foam::scalar Foam::uspReaction::mR
(
    const uspParcel& p,
    const uspParcel& q
) const
...
Foam::scalar Foam::uspReaction::translationalEnergy
(
    const uspParcel& p,
    const uspParcel& q
) const
...
Foam::scalar Foam::uspReaction::omega
(
    const uspParcel& p,
    const uspParcel& q
) const
...
Foam::scalar Foam::uspReaction::thetaD
(
    const uspParcel& p
) const
{
...
Foam::scalar Foam::uspReaction::thetaV
(
    const uspParcel& p
) const
{
...
Foam::scalar Foam::uspReaction::Zref
(
    const uspParcel& p
) const
{
...
Foam::scalar Foam::uspReaction::refTempZv
(
    const uspParcel& p
) const
{
...
Foam::label Foam::uspReaction::charDissLevel
(
    const uspParcel& p
) const
{
...
Foam::label Foam::uspReaction::jMax
(
    const uspParcel& p
) const
{
...
Foam::label Foam::uspReaction::rotationalDof
(
    const uspParcel& p
) const
{
...
Foam::vector Foam::uspReaction::Ucm
(
    const uspParcel& p,
    const uspParcel& q
) const
...
Foam::scalarList Foam::uspReaction::EEList
(
    const uspParcel& p
) const
{
...
Foam::labelList Foam::uspReaction::gList
(
    const uspParcel& p
) const
{
...
Foam::autoPtr<Foam::uspReaction> Foam::uspReaction::New
(
    const Time& t,
    uspCloud& cloud,
    const dictionary& dict
)
{
    ...
    return autoPtr<uspReaction>(cstrIter()(t, cloud, dict));
}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void Foam::uspReaction::setCommonReactionProperties()
{
...
void Foam::uspReaction::associativeIonisation
(
...
void Foam::uspReaction::exchangePQ
(
...
void Foam::uspReaction::chargeExchangePQ
(
    const scalar& heatOfReactionExchJoules,
...
bool Foam::uspReaction::relax() const
{
    return relax_;
}


const Foam::uspCloud& Foam::uspReaction::cloud() const
{
    return cloud_;
}


bool Foam::uspReaction::outputResults(const label counterIndex)
{
