...
#include "EllipsoidalStatistical2ndOrderRelaxation.H"
...
namespace Foam
{
defineTypeNameAndDebug(EllipsoidalStatistical2ndOrderRelaxation, 0);

addToRunTimeSelectionTable(relaxationModel, EllipsoidalStatistical2ndOrderRelaxation, dictionary);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::EllipsoidalStatistical2ndOrderRelaxation::EllipsoidalStatistical2ndOrderRelaxation
(
...
void Foam::EllipsoidalStatistical2ndOrderRelaxation::calculateProperties()
{
...
void Foam::EllipsoidalStatistical2ndOrderRelaxation::resetProperties()
{
...
void Foam::EllipsoidalStatistical2ndOrderRelaxation::relax()
{
...
void Foam::EllipsoidalStatistical2ndOrderRelaxation::conserveMomentumAndEnergy
(
    const label& cell
)
{
...
Foam::vector Foam::EllipsoidalStatistical2ndOrderRelaxation::samplePostRelaxationVelocity
(   
    const scalar& m,
    const scalar& Pr,
    const scalar& p,
