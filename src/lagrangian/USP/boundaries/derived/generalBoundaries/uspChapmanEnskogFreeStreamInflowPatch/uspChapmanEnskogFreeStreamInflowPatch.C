...
#include "uspChapmanEnskogFreeStreamInflowPatch.H"
...
namespace Foam
{
defineTypeNameAndDebug(uspChapmanEnskogFreeStreamInflowPatch, 0);

addToRunTimeSelectionTable
(
    uspGeneralBoundary,
    uspChapmanEnskogFreeStreamInflowPatch,
    dictionary
);
}
...
Foam::uspChapmanEnskogFreeStreamInflowPatch::uspChapmanEnskogFreeStreamInflowPatch
(
    const polyMesh& mesh,
    uspCloud& cloud,
...
void Foam::uspChapmanEnskogFreeStreamInflowPatch::initialConfiguration()
{}


void Foam::uspChapmanEnskogFreeStreamInflowPatch::calculateProperties()
{}


void Foam::uspChapmanEnskogFreeStreamInflowPatch::controlParcelsBeforeMove()
{
...
void Foam::uspChapmanEnskogFreeStreamInflowPatch::controlParcelsBeforeCollisions()
{}


void Foam::uspChapmanEnskogFreeStreamInflowPatch::controlParcelsAfterCollisions()
{}


void Foam::uspChapmanEnskogFreeStreamInflowPatch::output
(
...
void Foam::uspChapmanEnskogFreeStreamInflowPatch::updateProperties(const dictionary& dict)
{
