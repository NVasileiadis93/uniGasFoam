...
namespace Foam
{
defineTypeNameAndDebug(uspCLLWallPatch, 0);
addToRunTimeSelectionTable(uspPatchBoundary, uspCLLWallPatch, dictionary);
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::uspCLLWallPatch::uspCLLWallPatch
(
    const polyMesh& mesh,
    uspCloud& cloud,
...
void Foam::uspCLLWallPatch::calculateProperties()
{}


void Foam::uspCLLWallPatch::controlParticle
(
    uspParcel& p,
...
void Foam::uspCLLWallPatch::output
(
...
void Foam::uspCLLWallPatch::updateProperties(const dictionary& dict)
{
