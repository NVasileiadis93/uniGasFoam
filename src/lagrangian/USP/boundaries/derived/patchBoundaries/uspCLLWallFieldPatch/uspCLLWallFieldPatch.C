...
#include "uspCLLWallFieldPatch.H"
...
namespace Foam
{
defineTypeNameAndDebug(uspCLLWallFieldPatch, 0);

addToRunTimeSelectionTable
(
    uspPatchBoundary,
    uspCLLWallFieldPatch,
    dictionary
);
}
...
Foam::uspCLLWallFieldPatch::uspCLLWallFieldPatch
(
    const polyMesh& mesh,
    uspCloud& cloud,
...
void Foam::uspCLLWallFieldPatch::calculateProperties()
{}


void Foam::uspCLLWallFieldPatch::controlParticle
(
    uspParcel& p,
...
void Foam::uspCLLWallFieldPatch::output
(
...
void Foam::uspCLLWallFieldPatch::updateProperties(const dictionary& dict)
{
