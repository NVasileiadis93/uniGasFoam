...
#include "uspAdiabaticWallPatch.H"
...
defineTypeNameAndDebug(uspAdiabaticWallPatch, 0);

addToRunTimeSelectionTable(uspPatchBoundary, uspAdiabaticWallPatch, dictionary);
...
uspAdiabaticWallPatch::uspAdiabaticWallPatch
(
    Time& t,
    const polyMesh& mesh,
    uspCloud& cloud,
...
:
    uspPatchBoundary(t, mesh, cloud, dict),
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
void uspAdiabaticWallPatch::initialConfiguration()
{
    forAll(cells_, c)
    {
...
void uspAdiabaticWallPatch::calculateProperties()
{            
    ...
    forAll(cells_, c)
    {
        ...
        forAll(parcelsInCell, pIC)
        {
            ...
            const uspParcel::constantProperties& constProp 
...
void uspAdiabaticWallPatch::controlParticle(uspParcel& p, uspParcel::trackingData& td)
{
...
void uspAdiabaticWallPatch::output
(
...
void uspAdiabaticWallPatch::updateProperties(const dictionary& newDict)
{
...
void uspAdiabaticWallPatch::setProperties()
{
