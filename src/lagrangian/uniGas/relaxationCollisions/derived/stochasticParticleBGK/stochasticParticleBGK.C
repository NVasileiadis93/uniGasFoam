...
addToRunTimeSelectionTable(relaxationCollisionModel, stochasticParticleBGK, dictionary);
}
...
void Foam::stochasticParticleBGK::relax()
{
...
Foam::vector Foam::stochasticParticleBGK::samplePostRelaxationVelocity
(   
    const scalar& m,
    const scalar& T,
    const vector& U
