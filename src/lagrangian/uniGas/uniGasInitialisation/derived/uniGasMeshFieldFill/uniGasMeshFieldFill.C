...
namespace Foam
{
defineTypeNameAndDebug(uniGasMeshFieldFill, 0);
...
Foam::uniGasMeshFieldFill::uniGasMeshFieldFill(uniGasCloud& cloud, const dictionary& dict)
:
...
void Foam::uniGasMeshFieldFill::setInitialConfiguration()
{
