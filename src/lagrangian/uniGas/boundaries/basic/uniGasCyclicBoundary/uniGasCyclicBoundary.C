...
namespace Foam
{
defineTypeNameAndDebug(uniGasCyclicBoundary, 0);
defineRunTimeSelectionTable(uniGasCyclicBoundary, dictionary);
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::uniGasCyclicBoundary::uniGasCyclicBoundary
(
    const polyMesh& mesh,
    uniGasCloud& cloud,
...
:
    uniGasBoundaryBase(mesh, cloud, dict, "cyclic"),
    neighbPatchName_(),
    neighbPatchId_(0),
...
void Foam::uniGasCyclicBoundary::getCoupledFaces(const polyMesh& mesh)
{
...
Foam::autoPtr<Foam::uniGasCyclicBoundary> Foam::uniGasCyclicBoundary::New
(
    const polyMesh& mesh,
    uniGasCloud& cloud,
    const dictionary& dict
)
{
    ...
    Info<< "Selecting uniGasCyclicBoundaryModel " << modelType << endl;
    ...
    return autoPtr<uniGasCyclicBoundary>(cstrIter()(mesh, cloud, dict));
}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

const Foam::labelList& Foam::uniGasCyclicBoundary::controlPatch() const
{
    return coupledFacesA_;
}


const Foam::labelList& Foam::uniGasCyclicBoundary::controlZone() const
{
    return cellsA_;
}


const Foam::labelList& Foam::uniGasCyclicBoundary::allFaces() const
{
    return faces_;
}
