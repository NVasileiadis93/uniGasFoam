...
#include "uniGasWangPressureInletPatch.H"
...
namespace Foam
{
defineTypeNameAndDebug(uniGasWangPressureInletPatch, 0);
...
Foam::uniGasWangPressureInletPatch::uniGasWangPressureInletPatch
(
    const polyMesh& mesh,
    uniGasCloud& cloud,
...
void Foam::uniGasWangPressureInletPatch::initialConfiguration()
{}


void Foam::uniGasWangPressureInletPatch::calculateProperties()
{}


void Foam::uniGasWangPressureInletPatch::controlParcelsBeforeMove()
{
    insertParcels
    (
        inletTemperature_,
...
void Foam::uniGasWangPressureInletPatch::controlParcelsBeforeCollisions()
{}


void Foam::uniGasWangPressureInletPatch::controlParcelsAfterCollisions()
{
    nTimeSteps_ += 1.0;
    ...
    forAll(cells_, c)
    {
        ...
        for (uniGasParcel* p : cellOccupancy[cells_[c]])
        {
...
void Foam::uniGasWangPressureInletPatch::output
(
...
void Foam::uniGasWangPressureInletPatch::updateProperties(const dictionary& dict)
{
